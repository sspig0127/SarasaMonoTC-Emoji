...
- 目前主線：`v2.0` sequence emoji（ZWJ / 膚色 / 旗幟）
- 下次開新對話時先看：
  - `CLAUDE.md`
  - `docs/current-focus.md`
  - `docs/v2-sequence-implementation.md`
- 查歷史脈絡時再看：
  - `docs/roadmap-history.md`
  - `.github/colrv1-dev-notes.md`

不要把這些細節硬記在對話上下文裡：
- 過去每次 release / commit / push 細節
- COLRv1 bug 的逐步排查過程
- 本地 worktree 的暫時性 zip / png / 驗證截圖狀態
...
| `docs/v2-sequence-implementation.md` | 準備開始做 v2.0 sequence emoji 時 |
