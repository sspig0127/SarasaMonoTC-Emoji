...
| `max_new_glyphs` | 8,450 | 2026-04-05 擴增 |
| 目前實際消耗 | **8,327 / 8,450** | 單碼 7,328 + sequence 999 |
| **config 緩衝** | **123 slots** | 8,450 − 8,327；可繼續加 sequence |
| 合併後 glyph 數（Italic） | 65,232 | Sarasa 56,905 + emoji 8,327 |
| **TrueType 硬上限距離** | **303 slots** | 65,535 − 65,232（最壞情況）；不可超越 |
| 全量 COLRv1 需求 | ~18,000+ | 完全不可行 |

**結論**：方向一、二、三已於 2026-04-05 全部實作完成。config 緩衝 123 slots 可繼續調整 sequence；TrueType 硬上限距離 303 slots（Italic 最壞情況）。
