...
#### T1 — 基本測試框架
- [ ] 建立 `tests/` 目錄結構
- [ ] `tests/test_font_output.py`：驗證建構結果
...
| Mac platform name 移除時機 | `emoji_merge.py:104-118` | 在 `update_font_names()` 之後呼叫，順序敏感 |
